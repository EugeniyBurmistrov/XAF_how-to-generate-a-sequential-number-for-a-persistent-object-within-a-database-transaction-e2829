...
namespace GenerateUserFriendlyId.Web {
    public class Global : System.Web.HttpApplication {
        ...
        protected void Session_Start(Object sender, EventArgs e) {
            ...
            SequenceGenerator.DefaultDataLayer = XpoDefault.GetDataLayer(WebApplication.Instance.Connection == null ? WebApplication.Instance.ConnectionString : WebApplication.Instance.Connection.ConnectionString, DevExpress.Xpo.DB.AutoCreateOption.DatabaseAndSchema);
