...
namespace GenerateUserFriendlyId.Module.Utils {
    ...
    public static class SequenceGeneratorInitializer {
        ...
        public static void Initialize() {
            ...
            ObjectSpaceProvider provider = Application.ObjectSpaceProvider as ObjectSpaceProvider;
            Guard.ArgumentNotNull(provider, "provider");
            if (provider.WorkingDataLayer == null) {
                //Dennis: This call is necessary to initialize a working data layer.
                provider.CreateObjectSpace();
            }
            if (provider.WorkingDataLayer is ThreadSafeDataLayer) {
                ...
                SequenceGenerator.DefaultDataLayer = XpoDefault.GetDataLayer(Application.Connection == null ? Application.ConnectionString : Application.Connection.ConnectionString, DevExpress.Xpo.DB.AutoCreateOption.None);
            }
            else {
