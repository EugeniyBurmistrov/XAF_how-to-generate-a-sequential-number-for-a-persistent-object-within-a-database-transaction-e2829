    ...
    <asp:PlaceHolder ID="ph" runat="server">
                                ...
                                <td id="LPcell" style="width: 200px; vertical-align: top;">
                                    <div id="LP" class="LeftPane" style="width: 200px;">
                                        <cc2:ActionContainerHolder ID="VTC" runat="server" Orientation="Vertical" Categories="Tools"
                                            BorderWidth="0px" ContainerStyle="Links" ShowSeparators="True" />
     ...
     <!--
            function OnLoad() {
                ...
                OnLoadCore("LPcell", "separatorCell", "separatorImage", eval(<%= (VTC.HasActiveActions() || DAC.HasActiveActions())? "true" : "false" %>), true);
            }
         // -->
        </script>
    </asp:PlaceHolder>
