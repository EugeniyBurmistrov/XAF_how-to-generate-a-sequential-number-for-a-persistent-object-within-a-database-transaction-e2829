...
Namespace GenerateUserFriendlyId.Module.BO
	Public MustInherit Class BasePersistentObject
		...
		Private Sub Session_AfterCommitTransaction(ByVal sender As Object, ByVal e As SessionManipulationEventArgs)
			...
			End If
		End Sub
		Protected Overridable Sub OnSequenceGenerated(ByVal newId As Long)
		...
		End Property
	End Class
	<DefaultClassOptions, DefaultProperty("FullAddress")> _
	Public Class Address
		...
		End Sub
	End Class
	<DefaultClassOptions, DefaultProperty("FullName")> _
