...
#End If
			...
			End If
			SequenceGenerator.DefaultDataLayer = XpoDefault.GetDataLayer(If(WebApplication.Instance.Connection Is Nothing, WebApplication.Instance.ConnectionString, WebApplication.Instance.Connection.ConnectionString), DevExpress.Xpo.DB.AutoCreateOption.DatabaseAndSchema)
		...
		Protected Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
			'GenerateUserFriendlyId.Module.BO.BasePersistentObject.OnError(GetLastException());
