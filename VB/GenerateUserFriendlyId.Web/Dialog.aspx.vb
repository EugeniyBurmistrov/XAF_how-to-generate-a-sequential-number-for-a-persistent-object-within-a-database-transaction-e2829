...
Partial Public Class DialogPage
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		CallbackManager.RegisterCallbackUpdateControl(ErrorInfo)
		CallbackManager.RegisterCallbackUpdateControl(SearchActionContainer)
		CallbackManager.RegisterCallbackUpdateControl(VSC)
		CallbackManager.RegisterCallbackUpdateControl(actionContainerHolder)
	End Sub
