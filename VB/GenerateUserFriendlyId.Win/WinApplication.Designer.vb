...
Namespace GenerateUserFriendlyId.Win
	Partial Public Class GenerateUserFriendlyIdWindowsFormsApplication
		...
		Private Sub InitializeComponent()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=GenerateUserFriendlyId;Integrated Security=SS" & "PI;Pooling=false"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.GenerateUserFriendlyIdWindowsFormsApplication_DatabaseVersionMismatch);
